...
data class TimerUiState(
    ...
    val showRouxHint: Boolean = false,
    val showRouxSecondBlockHint: Boolean = false,
...
data class TimerActions(
    ...
    val onRouxHintClick: () -> Unit = {},
    val onRouxSecondBlockHintClick: () -> Unit = {},
        ...
        Column(
            ...
            if (!uiState.isRunning) {
                ScrambleBox(
                    ...
                    showRouxHint = uiState.showRouxHint,
                    showRouxSecondBlockHint = uiState.showRouxSecondBlockHint,
                    ...
                    onRouxHintClick = currentActions.onRouxHintClick,
                    onRouxSecondBlockHintClick = currentActions.onRouxSecondBlockHintClick,
