...
public class ExportImportDialog extends DialogFragment
    ...
    private DialogExportImportBinding binding;
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.export_button:
                    AnimUtils.toggleContentVisibility(binding.exportBackup, binding.exportExternal);
                    break;

                case R.id.import_button:
                    AnimUtils.toggleContentVisibility(binding.importBackup, binding.importExternal);
                    break;
